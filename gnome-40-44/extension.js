...
class HijriDateDisplayExtension {
    constructor() {
    ...
    enable() {
        this._settings = ExtensionUtils.getSettings('org.gnome.shell.extensions.hijridate');
...
function init() {
    return new HijriDateDisplayExtension();
}